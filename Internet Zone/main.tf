...
# Create nsg
module "azure-nsg" {
  source            = "../modules/network/nsg-internet"
  rg-name           = "${var.rg-name}"
  location          = "${var.location}"
...
module "gut-subnet" {
  ...
  rg-name     = "${var.rg-name}"
  vnet-name   = "${var.vnetname}"
  subnet-name = "gut-${var.subnet-name}"
  subnet-cidr = "${var.gut-subnet-cidr}"
}
...
module "nic-gut-1" {
  ...
  rg-name       = "${var.rg-name}"
  location      = "${var.location}"
  nic-name      = "${var.gut-nic-name}"
  nic-subnet-id = "${module.gut-subnet.subnet-id}"
  nic-nsg-id    = "${module.azure-nsg.nsg-gut-id}"
}
...
module "vm-gut-1" {
  ...
  rg-name         = "${var.rg-name}"
  location        = "${var.location}"
  nic-id          = "${module.nic-gut-1.nic-id}"
  vm-name         = "${var.gut-vm-name}"
  vm-size         = "${var.gut-vm-size}"
  vm-az           = ["${var.gut-vm-az[0]}"]
  image-publisher = "${var.gut-vm-image-publisher}"
  image-offer     = "${var.gut-vm-image-offer}"
  image-sku       = "${var.gut-vm-image-sku}"
  image-version   = "${var.gut-vm-image-version}"
  os-hostname     = "${var.gut-os-hostname}"
  os-username     = "${var.gut-os-username}"
  os-password     = "${var.gut-os-password}"
  os-disk-type    = "${var.gut-disk-type}"
  data-disk-size  = "${var.gut-data-disk-size}"
  data-disk-type  = "${var.gut-data-disk-type}"
}
...
module "it-subnet" {
  ...
  rg-name     = "${var.rg-name}"
  vnet-name   = "${var.vnetname}"
  subnet-name = "it-${var.subnet-name}"
  subnet-cidr = "${var.it-subnet-cidr}"
}
...
module "nic-it-1" {
  ...
  rg-name       = "${var.rg-name}"
  location      = "${var.location}"
  nic-name      = "${var.it-nic-name}"
  nic-subnet-id = "${module.it-subnet.subnet-id}"
  nic-nsg-id    = "${module.azure-nsg.nsg-it-id}"
}
...
module "vm-it-1" {
  ...
  rg-name         = "${var.rg-name}"
  location        = "${var.location}"
  nic-id          = "${module.nic-it-1.nic-id}"
  vm-name         = "${var.it-vm-name}"
  vm-size         = "${var.it-vm-size}"
  vm-az           = ["${var.it-vm-az[0]}"]
  image-publisher = "${var.it-vm-image-publisher}"
  image-offer     = "${var.it-vm-image-offer}"
  image-sku       = "${var.it-vm-image-sku}"
  image-version   = "${var.it-vm-image-version}"
  os-hostname     = "${var.it-os-hostname}"
  os-username     = "${var.it-os-username}"
  os-password     = "${var.it-os-password}"
  os-disk-type    = "${var.it-disk-type}"
  data-disk-size  = "${var.it-data-disk-size}"
  data-disk-type  = "${var.it-data-disk-type}"
}